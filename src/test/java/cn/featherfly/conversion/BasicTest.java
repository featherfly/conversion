...
public class BasicTest {
    ...
    public void testFormatConversion() {
        ...
        assertEquals(DateUtils.formartTime(timestamp),
                DateUtils.formartTime((Date) beanPropertyConversion.toObject("2002-2-2 14:15:16", beanProperty)));
        ...
        assertEquals(DateUtils.formartTime(timestamp),
                DateUtils.formartTime((Date) beanPropertyConversion.toObject("2002年2月2日 14时15分16秒", beanProperty)));
        assertEquals(DateUtils.formartTime(timestamp),
                DateUtils.formartTime((Date) beanPropertyConversion.toObject("2002/2/2 14:15:16", beanProperty)));
    ...
    public static void main(String[] args) {
        new BasicTest().testAssignConversion();
    }
}
